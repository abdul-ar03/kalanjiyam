...
public class Farming_Add_Product extends AppCompatActivity {
    ...
    public Product product;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.farming_add_product);
            product=new Product();
            progress= new Dialog(Farming_Add_Product.this);
